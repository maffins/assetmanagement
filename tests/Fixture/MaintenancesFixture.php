...
class MaintenancesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'contact_number' => ['type' => 'string', 'length' => 30, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'reciept_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'reciept_id' => 1,
            'created' => '2016-06-11 11:55:24',
            'modified' => '2016-06-11 11:55:24'
        ],
    ];
}
